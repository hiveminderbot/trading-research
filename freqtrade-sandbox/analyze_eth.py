...
df = pd.read_feather('user_data/data/coinbase/ETH_USDT-5m.feather')
...
print('ETH/USDT entry signals (RSI<30 + MACD cross up):', entry_signals.sum())
print('ETH/USDT exit signals (RSI>70 + MACD cross down):', exit_signals.sum())
